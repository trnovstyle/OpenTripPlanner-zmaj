...
class AlternativeLegsTest extends GtfsTest {
    ...
    void testPreviousLegs() throws Exception {
        ...
        final List<ScheduledTransitLeg> alternativeLegs =
                AlternativeLegs.getAlternativeLegs(originalLeg, 3, routingService, true);
    ...
    void testNextLegs() throws Exception {
        ...
        final List<ScheduledTransitLeg> alternativeLegs =
                AlternativeLegs.getAlternativeLegs(originalLeg, 3, routingService, false);
