...
public class GroupBySameFirstOrLastTripTest implements PlanTestConstants {
    ...
    public void testDifferentMatchScenarions() {
        ...
        assertMatch(
                newItinerary(A)
                        .bus(ID_1, T11_00, T11_05, C)
                        .build(),
                newItinerary(A)
                        .bus(ID_1, T11_00, T11_05, B)
                        .bus(ID_2, T11_10, T11_15, C)
                        .build(),
                true
        );
        ...
        assertMatch(
                newItinerary(A)
                        ...
                        .build(),
                newItinerary(A)
                        .bus(ID_2, T11_00, T11_05, B)
                        .bus(ID_1, T11_10, T11_15, C)
                        .build(),
                true
        );
        ...
        assertMatch(
                newItinerary(A)
                        ...
                        .build(),
                newItinerary(A)
                        .bus(ID_3, T11_00, T11_05, B)
                        .bus(ID_4, T11_10, T11_15, C)
                        .build(),
                false
        );
        ...
        assertMatch(
                newItinerary(A)
                        .bus(ID_1, T11_00, T11_05, B, TODAY)
                        .build(),
                newItinerary(A)
                        .bus(ID_1, T11_00, T11_05, B, TOMORROW)
                        .build(),
                false
        );
    }
