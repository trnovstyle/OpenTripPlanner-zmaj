...
public class AlertsUpdateHandlerTest extends GtfsTest {
    ...
    public void init() {
        ...
        alertsUpdateHandler.setAlertPatchService(new AlertPatchServiceImpl(graph));

        alertsUpdateHandler.setSiriFuzzyTripMatcher(new SiriFuzzyTripMatcher(graph.index, true));
    }

    @Test
    public void testSiriSxUpdateForStop() {
        init();
        assertTrue(alertsUpdateHandler.getAlertPatchService().getAllAlertPatches().isEmpty());
        ...
        final Collection<AlertPatch> stopPatches = alertsUpdateHandler.getAlertPatchService().getStopPatches(new AgencyAndId("FEED", stopId));
    ...
    public void testSiriSxUpdateForMultipleStops() {
        ...
        Collection<AlertPatch> stopPatches = alertsUpdateHandler.getAlertPatchService().getStopPatches(new AgencyAndId("FEED", stopId0));
        ...
        stopPatches = alertsUpdateHandler.getAlertPatchService().getStopPatches(new AgencyAndId("FEED", stopId1));
    ...
    public void testSiriSxUpdateForTrip() {
        ...
        final Collection<AlertPatch> tripPatches = alertsUpdateHandler.getAlertPatchService().getTripPatches(new AgencyAndId("FEED", tripId));
    ...
    public void testSiriSxUpdateForTripAndStopByVehicleJourney() {
        ...
        Collection<AlertPatch> tripPatches = alertsUpdateHandler.getAlertPatchService().getStopAndTripPatches(new AgencyAndId("FEED", stopId0), new AgencyAndId("FEED", tripId));
        ...
        tripPatches = alertsUpdateHandler.getAlertPatchService().getStopAndTripPatches(new AgencyAndId("FEED", stopId1), new AgencyAndId("FEED", tripId));
        assertNotNull(tripPatches);
        assertEquals(1, tripPatches.size());
    ...
    public void testSiriSxUpdateForLine() {
        ...
        final Collection<AlertPatch> tripPatches = alertsUpdateHandler.getAlertPatchService().getRoutePatches(new AgencyAndId("FEED", lineRef));
    ...
    public void testSiriSxUpdateForLineThenExpiry() {
        ...
        Collection<AlertPatch> tripPatches = alertsUpdateHandler.getAlertPatchService().getRoutePatches(new AgencyAndId("FEED", lineRef));
        ...
        tripPatches = alertsUpdateHandler.getAlertPatchService().getRoutePatches(new AgencyAndId("FEED", lineRef));
    ...
    private void assertLineAndStopAlerts(String situationNumber, String routeId, String stopId0, String stopId1) {
        ...
        Collection<AlertPatch> tripPatches = alertsUpdateHandler.getAlertPatchService().getStopAndRoutePatches(new AgencyAndId("FEED", stopId0), new AgencyAndId("FEED", routeId));
        ...
        tripPatches = alertsUpdateHandler.getAlertPatchService().getStopAndRoutePatches(new AgencyAndId("FEED", stopId1), new AgencyAndId("FEED", routeId));
