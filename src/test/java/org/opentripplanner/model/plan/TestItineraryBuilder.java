...
public class TestItineraryBuilder implements PlanTestConstants {
  ...
  public TestItineraryBuilder bus(int tripId, int startTime, int endTime, Place to, LocalDate serviceDay) {
    return bus(tripId, startTime, endTime, TRIP_FROM_STOP_INDEX, TRIP_TO_STOP_INDEX, to, serviceDay);
  }
