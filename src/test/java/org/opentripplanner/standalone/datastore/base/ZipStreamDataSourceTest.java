...
public class ZipStreamDataSourceTest {
    ...
    public void testAccessorsForNoneExistingFile() throws IOException {
        ...
        CompositeDataSource subject = new ZipStreamDataSource(new FileDataSource(target, GTFS));
        CompositeDataSource copySubject = new ZipStreamDataSource(new FileDataSource(copyTarget, GTFS));
