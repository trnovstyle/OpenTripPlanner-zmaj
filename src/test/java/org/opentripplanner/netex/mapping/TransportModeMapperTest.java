...
public class TransportModeMapperTest {
  private final TransportModeMapper transportModeMapper = new TransportModeMapper(TransitModeService.getDefault());

  private final TransitModeService transitModeService = TransitModeService.getDefault();
