...
public class TransitMode implements Serializable {
  ...
  public static final TransitMode TROLLEYBUS = new TransitMode(TransitMainMode.TROLLEYBUS);
  public static final TransitMode MONORAIL = new TransitMode(TransitMainMode.MONORAIL);
  ...
  private static final Map<TransitMainMode, TransitMode> MAIN_MODES = Stream.of(
          RAIL, COACH, SUBWAY, BUS, TRAM, FERRY, AIRPLANE, CABLE_CAR, GONDOLA, FUNICULAR, TROLLEYBUS, MONORAIL, FLEXIBLE
