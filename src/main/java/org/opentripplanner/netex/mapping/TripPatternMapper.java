...
public class TripPatternMapper {
    ...
    public void mapTripPattern(JourneyPattern journeyPattern, OtpTransitBuilder transitBuilder, NetexDao netexDao){
        ...
        org.opentripplanner.model.Route otpRoute = transitBuilder.getRoutes().get(AgencyAndIdFactory.createAgencyAndId(route.getLineRef().getValue().getRef()));
    ...
    private Stop findStopPlace(String pointInJourneyPatterRef, ServiceJourneyPattern serviceJourneyPattern, NetexDao netexDao, OtpTransitBuilder transitBuilder){
    ...
    private Stop findQuay(String pointInJourneyPatterRef, JourneyPattern journeyPattern, NetexDao netexDao, OtpTransitBuilder transitBuilder){
        List<PointInLinkSequence_VersionedChildStructure> points =
