...
public class AlternativeLegs {
    ...
    public static List<ScheduledTransitLeg> getAlternativeLegs(
        ...
        Comparator<ScheduledTransitLeg> legComparator =
                Comparator.comparing(ScheduledTransitLeg::getStartTime);
        ...
        return origins.stream()
                ...
                .flatMap(t -> generateLegs(routingService, timetableSnapshot, t, leg.getStartTime(), leg.getServiceDate(), searchBackward))
    ...
    private static Stream<ScheduledTransitLeg> generateLegs(
        ...
        Comparator<TripTimeOnDate> comparator = Comparator.comparing((TripTimeOnDate tts) -> tts.getServiceDayMidnight() + tts.getRealtimeDeparture());
        ...
        for (ServiceDate serviceDate : serviceDates) {
            ...
            for (TripTimes tripTimes : timetable.getTripTimes()) {
                ...
                if (skipByTripCancellation(tripTimes, false)) {continue;}
    ...
    private static Stream<T2<TripPattern, P2<Integer>>> withBoardingAlightingPositions(
        ...
        return IntStream.range(0, stops.size())
                ...
                .flatMap(boardingPosition -> Arrays.stream(alightingPositions)
