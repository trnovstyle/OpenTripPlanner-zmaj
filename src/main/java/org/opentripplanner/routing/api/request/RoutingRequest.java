 ...
 *                          either. It could be a part of itinerary-filtering after a Raptor search.
     ...
     */
    public Map<TransitMainMode, Integer> boardSlackForMode = new EnumMap<>(TransitMainMode.class);
     ...
     * Unit is seconds. Default value is not-set(empty map).
     */
    public Map<TransitMainMode, Integer> alightSlackForMode = new EnumMap<>(TransitMainMode.class);
