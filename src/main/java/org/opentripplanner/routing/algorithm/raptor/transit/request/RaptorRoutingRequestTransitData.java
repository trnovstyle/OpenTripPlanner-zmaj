...
public class RaptorRoutingRequestTransitData implements RaptorTransitDataProvider<TripSchedule> {
  ...
  @Override
  public RaptorTransferConstraintsSearch<TripSchedule> transferConstraintsSearch() {
    if(OTPFeature.ConstrainedTransfers.isOff() || transferService == null) { return null; }
