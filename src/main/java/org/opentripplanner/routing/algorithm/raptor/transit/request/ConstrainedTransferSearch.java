 ...
 */
public final class ConstrainedTransferSearch
        implements RaptorConstrainedTransferSearch<TripSchedule> {
    ...
    public ConstrainedTransferSearch(
    ...
    public final RaptorTripScheduleBoardOrAlightEvent<TripSchedule> find(
        ...
        return new ConstrainedTransferBoarding<>(
                tx, tripIndex, trip, targetStopPos, departureTime
        );
    }
