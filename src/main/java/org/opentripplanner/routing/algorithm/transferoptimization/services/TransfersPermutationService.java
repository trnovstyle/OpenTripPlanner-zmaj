...
public class TransfersPermutationService<T extends RaptorTripSchedule> {
  ...
  private final TripToTripTransfersService<T> t2tService;
  private final CostCalculator<T> costCalculator;
  private final RaptorSlackProvider slackProvider;

  public TransfersPermutationService(
      TripToTripTransfersService<T> t2tService,
  ...
  /**
   */
  public List<Path<T>> findAllTransitPathPermutations(Path<T> path) {
