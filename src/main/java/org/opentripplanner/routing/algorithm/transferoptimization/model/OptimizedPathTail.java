        ...
        extends PathBuilder<T> implements TransferOptimized
{
    ...
    private int transferPriorityCost = ConstrainedTransfer.NEUTRAL_PRIORITY_COST;
    ...
    private void addTransferPriorityCost(PathBuilderLeg<T> pathLeg) {
        this.transferPriorityCost += ConstrainedTransfer.priorityCost(
                (ConstrainedTransfer) pathLeg.transferConstraintsAfterLeg()
        );
    }
    ...
    private void addWaitTimeCost(PathBuilderLeg<?> pathLeg) {
        ...
        System.out.printf(
                "%6d  %3d  %6d  >>  %s%n",
                cost, waitTime, waitTimeOptimizedCost, this
        );
    }
}
