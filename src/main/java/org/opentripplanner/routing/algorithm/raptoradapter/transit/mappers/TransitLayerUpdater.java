...
public class TransitLayerUpdater {
  ...
  public void update(Set<Timetable> updatedTimetables, Map<TripPattern, SortedSet<Timetable>> timetables) {
    ...
    for (LocalDate date : datesToBeUpdated) {
      ...
      for (Map.Entry<TripPattern, Collection<TripPatternForDate>> entry : oldTripPatternsForDate.asMap().entrySet()) {
      ...
      for (Map.Entry<TripPattern, Collection<TripPatternForDate>> entry : newTripPatternsForDate.asMap().entrySet()) {
