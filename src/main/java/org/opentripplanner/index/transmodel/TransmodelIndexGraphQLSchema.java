...
//                                                                        .build())
        ...
        GraphQLFieldDefinition tripFieldType = GraphQLFieldDefinition.newFieldDefinition()
                ...
                .argument(GraphQLArgument.newArgument()
                        ...
                        .build())
                .argument(GraphQLArgument.newArgument()
                        .name("allowServiceJourneyReUse")
                        .description("Whether or not the same ServiceJourney may be returned as a part of more than one tripPattern.For debugging only.")
                        .type(Scalars.GraphQLBoolean)
                        .defaultValue(defaultRoutingRequest.allowTripReUse)
                        .build())
                .argument(GraphQLArgument.newArgument()
                        .name("walkBoardCost")
