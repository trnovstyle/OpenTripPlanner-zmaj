 ...
 * the status file before the process terminate. I the {@link ##exitStatusOk()} is called, the status
 * is set to ok, otherwise it will be failed.
 * <p/>
 ...
 * {@link #exitStatusFailed()} is optional, and if called before the {@link #exitStatusOk()} the status is
 * set to failed.
 */
public class OtpStatusFile extends Thread {
    private static final Logger LOG = LoggerFactory.getLogger(OtpStatusFile.class);
    private static final OtpStatusFile INSTANCE = new OtpStatusFile();
