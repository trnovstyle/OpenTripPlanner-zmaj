 ...
 * See {@link #headPathBuilder(RaptorPathTransferConstraintsSearch, RaptorSlackProvider, CostCalculator)}
 * and {@link #tailPathBuilder(RaptorPathTransferConstraintsSearch, RaptorSlackProvider, CostCalculator)}
 * <p>
...
public abstract class PathBuilder<T extends RaptorTripSchedule> {
  ...
  @Nullable
  private final RaptorPathTransferConstraintsSearch<T> transferConstraintsSearch;
  ...
  protected PathBuilder(
          @Nullable RaptorPathTransferConstraintsSearch<T> transferConstraintsSearch,
