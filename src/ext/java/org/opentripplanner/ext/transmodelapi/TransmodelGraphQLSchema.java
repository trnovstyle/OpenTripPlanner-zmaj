  ...
  private GraphQLSchema create() {
    ...
    */
    ...
    GraphQLOutputType authorityType =
        AuthorityType.create(LineType.REF, PtSituationElementType.REF);
...
//  GraphQLOutputType carParkType = new GraphQLTypeReference("CarPark");
    ...
    GraphQLNamedOutputType ptSituationElementType = PtSituationElementType.create(
        authorityType, quayType, lineType, ServiceJourneyType.REF, multilingualStringType,
        validityPeriodType, infoLinkType, relay
    );
    GraphQLOutputType journeyPatternType = JourneyPatternType.create(
        linkGeometryType, noticeType, quayType, lineType, ServiceJourneyType.REF,
        ptSituationElementType, gqlUtil
    );
    ...
    GraphQLObjectType queryType = GraphQLObjectType
        ...
        .field(GraphQLFieldDefinition
            ...
            .dataFetcher(env -> {
              ...
              return StopPlaceType.fetchStopPlaces(
                  minLat, minLon, maxLat, maxLon, authority, filterByInUse, multiModalMode, env);
            })
            .build())
        .field(GraphQLFieldDefinition
            .newFieldDefinition()
            ...
            .dataFetcher(environment -> {
              return GqlUtil.getRoutingService(environment)
                  .getStopForId(TransitIdMapper.mapIDToDomain(
        ...
        .field(GraphQLFieldDefinition.newFieldDefinition()
            ...
            .dataFetcher(environment -> {
              ...
              @SuppressWarnings("rawtypes") Map filterByIds =
                  environment.getArgument("filterByIds");
              if (filterByIds != null) {
                filterByStops = toIdList(((List<String>) filterByIds.get("quays")));
                filterByRoutes = toIdList(((List<String>) filterByIds.get("lines")));
                filterByBikeRentalStations =
                    filterByIds.get("bikeRentalStations") != null ? (List<String>) filterByIds.get(
                        "bikeRentalStations") : Collections.emptyList();
                filterByBikeParks =
                    filterByIds.get("bikeParks") != null ? (List<String>) filterByIds.get(
                        "bikeParks") : Collections.emptyList();
              ...
              return GqlUtil.getRoutingService(environment)
                  ...
                  .filter(t -> {
                    return CollectionUtils.isEmpty(activeDates)
                        ...
                        .stream()
                        .anyMatch(sd -> activeDates.contains(
