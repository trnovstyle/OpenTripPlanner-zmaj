            ...
            for (RecordedCall recordedCall : recordedCalls) {
                ...
                if (foundMatch) {
                    ...
                    if (recordedCall.getActualArrivalTime() != null) {
                        ...
                        realtimeArrivalTime = DateMapper.secondsSinceStartOfService(departureDate, recordedCall.getActualDepartureTime(), zoneId);
                        //Flag as recorded
                        newTimes.setRecorded(callCounter, true);
                        ...
                        realtimeArrivalTime = DateMapper.secondsSinceStartOfService(departureDate, recordedCall.getExpectedDepartureTime(), zoneId);
                    ...
                    // Do not use actual arrival time for departure time, as the bus can be currently at the stop
                    else if (recordedCall.getExpectedDepartureTime() != null) {
                        realtimeDepartureTime = DateMapper.secondsSinceStartOfService(departureDate, recordedCall.getExpectedDepartureTime(), zoneId);
                    } else if (recordedCall.getExpectedArrivalTime() != null) {
                        realtimeDepartureTime = DateMapper.secondsSinceStartOfService(departureDate, recordedCall.getExpectedArrivalTime(), zoneId);
                ...
                for (EstimatedCall estimatedCall : estimatedCalls) {
                    ...
                    if (foundMatch) {
                        ...
                        if (estimatedCall.getExpectedArrivalTime() != null) {
                            ...
                            realtimeArrivalTime = DateMapper.secondsSinceStartOfService(departureDate, estimatedCall.getExpectedDepartureTime(), zoneId);
                        ...
                        if (estimatedCall.getExpectedDepartureTime() != null) {
                            ...
                            realtimeDepartureTime = DateMapper.secondsSinceStartOfService(departureDate, estimatedCall.getExpectedArrivalTime(), zoneId);
